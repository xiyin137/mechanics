...
can be regularized by changing variables and time scale, while triple collision
is the obstruction left out of Sundman's global statement; in the three-body
problem it is tied to the exceptional zero-angular-momentum collapse channel.
...
the exact conservation laws of Newtonian mechanics but destroys generic
...
three-body problem, finite-time singularities require collision. Xia's 1992
...
The center-of-mass degree of freedom is dynamically trivial. Removing it
explicitly shows exactly which variables remain in the interacting problem. Let
\[
...
because the inverse-square potential has an accidental Kepler symmetry. Central
...
\begin{tikzpicture}[scale=1.15, >=Latex, font=\small]
  ...
  \node[red!75!black, align=center, fill=white, inner sep=1.5pt] at (1.92,1.33)
