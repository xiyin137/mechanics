...
concepts that the next chapter converts into Hamiltonian phase space. The
...
\begin{tikzpicture}[scale=1.0, >=Latex]
  ...
  \node[red, align=left, fill=white, inner sep=1.5pt] at (4.95,1.05)
...
gradients. Hence the constrained equations take the multiplier form
\[
  \frac{\dd}{\dd t}\frac{\partial L}{\partial \dot q^i}
  -
  \frac{\partial L}{\partial q^i}
...
large dividend. A symmetry is a transformation of the configuration space that
leaves the Lagrangian, and therefore the action, unchanged. The infinitesimal
version of that transformation is a vector field \(\xi_Q\) along which the
action has zero first variation. The conserved quantity is the momentum paired
with that vector field.
...
\begin{tikzpicture}[scale=1.0, >=Latex, font=\small]
  ...
  \draw[<->, blue!70!black] (0.624,-1.58) -- (2.52,-1.58)
    node[midway, below=2pt] {allowed radial interval};
...
These ideas are the input for the next chapter. The Legendre transform converts
the boundary momentum into a phase-space coordinate, and the same action
principle then becomes the symplectic Hamiltonian formalism.
...
\begin{tikzpicture}[x=0.82cm,y=1.0cm, >=Latex, font=\small]
  ...
  \node[blue!70!black, fill=white, inner sep=1.5pt] at (5.9,0.28) {\(q(t)\)};
...
\begin{tikzpicture}[scale=1.0, >=Latex, font=\small]
  ...
  \begin{scope}[xshift=5.0cm, xscale=0.58]
    ...
    \draw[red!75!black, thick, domain=-3.1416:3.1416, samples=180]
      plot (\x,{-0.95*sin(\x r)*sin(\x r)-0.45*cos(\x r)+0.25});
...
\begin{tikzpicture}[scale=1.0, >=Latex, font=\small]
  ...
  \node[red!75!black, fill=white, inner sep=1pt] at (1.92,2.32) {\(N\)};
  \draw[->, black!70, thick] (1.65,1.65) -- (1.65,0.75)
    node[below] {\(mg\)};
  \draw[->, blue!70!black, thick] (2.1,1.65) arc (0:65:0.45);
  \node[blue!70!black, fill=white, inner sep=1pt] at (2.33,2.08) {\(\dot\phi\)};
...
\begin{tikzpicture}[x=0.62cm,y=1.25cm, >=Latex, font=\small]
  ...
  \draw[dashed] (1.0,-0.15) -- (1.0,2.05) node[above] {\(R\)};
  \draw[dashed] (3.0,-0.15) -- (3.0,2.05) node[above] {\(3R\)};
  ...
  \node[red!75!black, fill=white, inner sep=1.5pt] at (2.95,1.90)
  ...
  \draw[red!75!black, thick, ->] (2.65,1.78) -- (2.05,1.52);
