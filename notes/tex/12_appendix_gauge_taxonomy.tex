...
\[
        ...
        \Ad_{h^{-1}}A+h^{-1}\dd h .
\]
This formula explains the word ``gauge.''  The local coefficients of
connection depend on the chosen frame, but geometric predictions do not.
Holonomy around a closed shape loop changes by conjugation, and conjugacy
invariants are frame-independent.

\section{Curvature And Small Loops}
\label{sec:gauge-curvature-taxonomy}

The curvature of a connection is the \(\mathfrak{g}\)-valued two-form
\[
...
\[
        ...
        [A_\alpha,A_\beta].
\]
The bracket term is the non-Abelian correction.  It vanishes for a translation
group \(\R^m\), but not for rotations or rigid motions.
...
and frames are choices; holonomy and reconstructed motion are physical after a
frame convention is fixed.
