...
\[
  \Theta=p_i\,\dd q^i.
\]
This formula is intrinsic, although it is written in coordinates. If
...
\begin{proof}
Cartan's formula gives\footnote{For any differential form \(\alpha\) and vector
...
The type-II function used above is one member of the standard local family. The
four common choices are distinguished by which old and new variables are treated
as independent:
\[
\begin{array}{c|c|c}
...
\begin{tikzpicture}[scale=1.0, >=Latex, font=\small]
  ...
  \draw[decorate, decoration={brace, amplitude=5pt}]
    (1.35,-0.57) -- (1.35,0.57)
    node[midway, right=8pt, fill=white, inner sep=1.5pt, align=left]
