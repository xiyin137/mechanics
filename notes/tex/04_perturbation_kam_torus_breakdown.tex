...
\begin{tikzpicture}[scale=1.0, >=Latex, font=\small]
  \begin{scope}
    ...
    \node[red!75!black, align=center, fill=white, inner sep=1pt] at (1.15,-1.48)
      {three escape\\valleys};
    \node[anchor=west, fill=white, inner sep=1pt] at (0.52,2.08)
  ...
  \begin{scope}[xshift=5.2cm]
    ...
    \foreach \x/\y in {-1.3/0.9,-1.1/-0.8,-0.4/1.15,0.25/-1.2,1.0/0.75,1.25/-0.55}
      \fill[black!55] (\x,\y) circle (0.9pt);
    \node[anchor=west, fill=white, inner sep=1pt] at (0.42,1.58)
      {Poincare-section cartoon};
  \end{scope}
\end{tikzpicture}
