...
classical adiabatic analogue on invariant tori; Shapere and Wilczek (1989)
...
\(X=-\mathcal A_2\Delta s^2\) and
\(Y=-\mathcal A_1\Delta s^1\), so \([X,Y]=-[\mathcal A_1,\mathcal A_2]\Delta
